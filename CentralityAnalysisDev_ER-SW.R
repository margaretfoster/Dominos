...
## MJF: 12/9: Need to rework this, having only one centrality and
## iteration showing up. Seem to have missed an iteration call in ER-SWSingleScript.R?

library(dplyr)
library(ggplot2)
library(igraph)
load("ER-SWEvolutionSims.Rdata")

netstype= "ER-SW" ## code network types
...
table(tww2$column_label)## 208 each of 1-9
table(tww2$round) ## 261-270 in each
