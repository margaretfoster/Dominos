...
if(r == 2){ ## Look to the initial updator
    ...
    nodeIdeoUpdate <- ideologyUpdator(adjMatrix=am,
                                      nodeIdeology= allnodes[[r-1]]$nodeIdeo,
